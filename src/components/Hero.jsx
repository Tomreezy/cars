    ...
    <div className='relative h-[70vh] overflow-hidden '>
        <div className='absloute left-0 right-0 overflow-hidden'>
            ...
            <section className='absolute  space-y-3 z-30 left-[25%] top-[40%]'>
                <p className=' text-2xl text-white font-bold'>New & used cars for sale</p>
                ...
                <div className='bg-red-700 border border-red-700 border-solid flex items-center my-2 w-[50vw] rounded-lg overflow-hidden '>
                    <input placeholder='Try Volkswagen' className='bg-twhite outline-none w-[70%] py-3 px-3 ' type='text' />
                    <button className='p-1 flex  mx-auto font-semibold text-white'>Search Cars</button>
                </div>
            </section>
        </div>
    </div>
